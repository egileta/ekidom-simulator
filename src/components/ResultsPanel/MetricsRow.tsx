    ...
    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 3 }}>
          <div style={{ fontSize: 9, fontWeight: 700, letterSpacing: '1.8px', color: '#f59e0b', textTransform: 'uppercase' }}>
            Presupuesto
          </div>
          {/* Subsidy toggle */}
          <div
          ...
          >
            <span style={{ fontSize: 9, color: subsidyEnabled ? '#fbbf24' : '#475569', fontWeight: 600 }}>
              -{Math.round(FINANCE.SUBSIDY_RATE * 100)}%
            </span>
            <div style={{
              width: 28, height: 16, borderRadius: 8, position: 'relative', flexShrink: 0,
              background: subsidyEnabled ? 'rgba(245,158,11,0.55)' : 'rgba(255,255,255,0.10)',
